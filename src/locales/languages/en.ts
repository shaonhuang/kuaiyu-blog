export default {
  ...
  homePage: {
    ...
    content: "Good at dreaming<br>Indulge in programming<br>Love creativity",
    desc: "A front-end developer by now<br>Betting entire career on JavaScript Keep exploring",
  ...
  resumePage: {
    drawer: {
      drawerIconTooltip: "Other Versions",
      title: "Resume version",
      item_1: "(Old) Chinese Version",
      item_2: "Chinese Version",
      item_3: "English Version",
      item_download: "Download Current Resume"
    }
  },
  localeBotton: "Chinese"
};
